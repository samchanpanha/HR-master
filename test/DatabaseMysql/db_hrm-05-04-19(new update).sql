...
CREATE TABLE `interviewees`  (
  ...
  `Image` blob NULL,
  `Status` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'none',
  `Blocked` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'none',
  ...
  FULLTEXT INDEX `Name`(`Name`, `Language`, `Degree`, `Email`, `Status`, `Skill`)
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of interviewees
-- ----------------------------
INSERT INTO `interviewees` VALUES (1, 'roth', 'female', 'pp', '099887788', NULL, NULL, NULL, 'k', 'khmer , english', 'network', NULL, NULL);
INSERT INTO `interviewees` VALUES (2, 'sokthea', 'male', 'tk', '077889933', NULL, NULL, NULL, 'e', 'khmer,english,chinese', 'web,System_analyse', NULL, NULL);
INSERT INTO `interviewees` VALUES (3, 'vireak', 'male', 'ck', '010223399', NULL, NULL, NULL, 'k', 'chinese,khmer', 'it_exceutive,network_administrater', NULL, NULL);
INSERT INTO `interviewees` VALUES (4, 'roth', 'male', 'tke', '93276387', NULL, NULL, NULL, 'd', 'chinese,khmer,france', 'graphic_designer,network', NULL, NULL);
...
CREATE TABLE `majors`  (
  ...
  INDEX `mid`(`MajorId`) USING BTREE,
  FULLTEXT INDEX `type`(`Major`)
...
INSERT INTO `skills` VALUES (4, 'System_analyse');
INSERT INTO `skills` VALUES (5, 'it_exceutive');
INSERT INTO `skills` VALUES (6, 'network_administrater');
INSERT INTO `skills` VALUES (7, 'graphic_designer');
...
CREATE TABLE `studyrecords`  (
  ...
  FULLTEXT INDEX `des`(`Description`, `Skill`),
...
-- ----------------------------
-- Records of studyrecords
-- ----------------------------
INSERT INTO `studyrecords` VALUES (1, 2, 2, 2, 'i am sonthing', '2', '2019-03-28', 1);
INSERT INTO `studyrecords` VALUES (2, 3, 3, 2, 'i am sonthing i am sonthings i am sonthingskaj', '3', '2019-02-12', 3);
INSERT INTO `studyrecords` VALUES (3, 4, 1, 2, 'i am sonthingajhagjhgj i am sonthinghkhskwu', '1', '2018-06-28', 2);
INSERT INTO `studyrecords` VALUES (4, 1, 1, 1, 'i love you i love hers', '2', '2019-05-03', 3);
INSERT INTO `studyrecords` VALUES (5, 3, 2, 2, 'asertkgfdssdfgh', '2', '2019-03-29', 2);
...
CREATE TABLE `studyrecordtypes`  (
  ...
  INDEX `typeid`(`StudyRecordTypeId`) USING BTREE,
  FULLTEXT INDEX `type`(`StudyRecordType`)
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `workexperiences`  (
  ...
  INDEX `PositionId`(`PositionId`) USING BTREE,
  INDEX `IntervieweeId`(`IntervieweeId`) USING BTREE,
  FULLTEXT INDEX `dess`(`Description`, `Skill`),
  ...
  CONSTRAINT `workexperiences_ibfk_4` FOREIGN KEY (`IntervieweeId`) REFERENCES `interviewees` (`IntervieweeId`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of workexperiences
-- ----------------------------
INSERT INTO `workexperiences` VALUES (3, 2, 'okokme', 'network', '2019-03-29', '2020-03-29', 2, 1);
INSERT INTO `workexperiences` VALUES (4, 3, 'oknajaoktoyou', 'web', '2019-03-31', '2021-01-29', 4, 2);

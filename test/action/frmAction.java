...
public class frmAction extends javax.swing.JFrame {
    ...
    public frmAction() {
        ...
        this.modelAction=(DefaultTableModel)jTableAction.getModel();
        
    }

    DefaultTableModel modelAction;
    
    void changeButtonContext(){
        if(jTableAction.getSelectedRowCount()==1){
    ...
    void prepareForm(){
        ...
        clFunction.changeLookTable(jTableAction);
        
        jTableAction.getSelectionModel().addListSelectionListener((ListSelectionEvent lse) -> {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if(jTableAction.getSelectedRowCount()==1){
            jTableAction.clearSelection();
            btnAdd.doClick();
        }else{
           
            
            if(clAction.insert(txtAction.getText())){
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        clAction.getActionList(modelAction);
    }//GEN-LAST:event_formWindowOpened

    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        if(!clAction.delete(txtId.getText())) return;
        
        
        modelAction.removeRow(selectedRowIndex);
        btnAdd.doClick();
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        if(!clFunction.checkIfTextFieldEmpty(txtAction)){
            ...
            if(!clAction.update(txtId.getText(),txtAction.getText())) return;
            
            String []st={txtId.getText(),txtAction.getText()};
            
            for(int i=0;i<modelAction.getColumnCount();i++){
                modelAction.setValueAt(st[i],selectedRowIndex, i);
            }
    ...
    void getDataForEdit(){
        ...
        selectedRowIndex=jTableAction.getSelectedRow();
        
        txtId.setText(jTableAction.getValueAt(selectedRowIndex, 0)+"");
        txtAction.setText(jTableAction.getValueAt(selectedRowIndex, 1)+"");

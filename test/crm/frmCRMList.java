...
public class frmCRMList extends javax.swing.JFrame {
    ...
    public frmCRMList() {
        ...
        modelCRMList=(DefaultTableModel)jTableOpportunity.getModel();
        
        clCRM.getCRMList(modelCRMList);
    ...
    private void initComponents() {
        ...
        jTableOpportunity.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "OpportunityId", "Description", "Date Created", "Priority", "Status", "Employee", "Customer"
            }
        ) {
    ...
    private void popAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_popAddActionPerformed
        ...
        frmAddCRM pAddCRM=new frmAddCRM(modelCRMList);
    ...
    private void popDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_popDeleteActionPerformed
        ...
        String opportunityId=modelCRMList.getValueAt(selectedRowIndex, 0)+"";
        
        
        if(clCRM.delete(opportunityId))
        {
            modelCRMList.removeRow(selectedRowIndex);
        }
    ...
    private void popEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_popEditActionPerformed
        ...
        frmAddCRM pAddCRM=new frmAddCRM(selectedRowIndex,modelCRMList);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmCRMList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmCRMList().setVisible(true);
            }
        });
    }
